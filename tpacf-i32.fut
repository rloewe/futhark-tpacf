...
-- output @ small/output-data-i32
-- compiled input @ medium/input-data-i32
-- output @ medium/output-data
-- compiled input @ large/input-data
-- output @ large/output-data-i32
...
fun *[i32, numBins2] doCompute(
    ...
    let value = map(fn *[i32, numBins2] (f64 xOuter, f64 yOuter, f64 zOuter) =>
            streamMap(fn *[i32, numBins2] (int chunk, [vec3] inner) =>
...
fun *[i32, numBins2] doComputeSelf(
    [vec3, numD] data,
    i32 numBins,
    i32 numBins2,
    [f64, numBBins] binb
...
-- loop version
    let value = map(fn [i32, numBins2] (vec3 vec, i32 index) =>
...
fun *[i32, 60] main(
    ...
    let (rrs, drs) = unzip(map(fn (*[i32], *[i32]) ([vec3, numR] random) =>
